...
initPortf(portoflio.st, symbols = "SPY", initDate = initdate, currency = "USD")
...
test_subset <- test["20130901/20130905"]
...
add.rule(strategy.st, name = "ruleSignal",
         ...
         type = "exit")
# the replace argument specifies whether or not to ignore all other signals on the same date when the strategy acts upon one signal
...
SharpeRatio.annualized(portpl, geometric=FALSE) # quantstrat does not compound so set geometric=FALSE
